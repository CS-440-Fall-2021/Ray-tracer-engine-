...
void World::build() {
  ...
  this->Accelerate.init(this->geometry, this->walls, this->Worldbox);
  this->Accelerate.generateGrid();
...
//if want to view all geometry 
//put this in hit_objects and uncomment
...
ShadeInfo World::hit_objects(const Ray& ray, bool hit_walls) {
  ...
  //   return s_min_wall;
  // }
  return this->Accelerate.hit_objects(ray,*this,true);
}
